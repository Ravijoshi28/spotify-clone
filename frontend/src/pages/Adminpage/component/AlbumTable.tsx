...
function SongsTable() {
    const {albums,isloading,deleteAlbum}=useMusic()

   
    
    if(isloading) return (<div className="h-full items-center bg-zinc-800 text-zinc-400 ">Loading Albums</div>)
  return (
    <div>
        <Table>
            <TableHeader>
